...
$sql = "SELECT 
    ...
    ORDER BY lh.leavehis_start ASC
";
    ...
    <div>
        ...
        <script>
            function handleAction(leavehis_id, action) {
                ...
                let confirmButtonColor = action === 'approve' ? '#28a745' : '#dc3545'; 
            ...
            <tbody>
                ...
                if (count($leave_requests) > 0) {
                    foreach ($leave_requests as $leave) {
                        ...
                        if ($leave['status_name'] === 'อนุมัติ') {
                            echo "<td><span class='badge bg-success'>" . $leave['status_name'] . "</span></td>";
                        } elseif ($leave['status_name'] === 'ไม่อนุมัติ') {
                            echo "<td><span class='badge bg-danger'>" . $leave['status_name'] . "</span></td>";
                        } else {
