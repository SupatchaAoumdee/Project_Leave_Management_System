<div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container p-2 my-2" style="background-color: #ffffe0; font-size: 18px; font-family: 'NTFont', sans-serif;">
                ...
                <a class="navbar-brand" href="#" style="font-size: 28px; margin-right: 10px;">ระบบลาบริษัท NT</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="historyapprove.php">ประวัติการลา</a>
                        </li>
